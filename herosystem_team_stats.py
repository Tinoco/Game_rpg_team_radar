...
party = go.Figure(
    data=[
        go.Scatterpolar(r=paladin_1, theta=atributes, name='Paladin 1'),
        go.Scatterpolar(r=mage_2, theta=atributes, name='Mage 2'),
        go.Scatterpolar(r=archer_3, theta=atributes, name='Archer 3')
    ],
    layout=go.Layout(
