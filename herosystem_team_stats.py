...
party = go.Figure(
    data=[
        go.Scatterpolar(r=paladin_1, theta=atributes, name='Tristan'),
        go.Scatterpolar(r=mage_2, theta=atributes, name='Joe'),
        go.Scatterpolar(r=archer_3, theta=atributes, name='Tea')
    ],
    layout=go.Layout(
